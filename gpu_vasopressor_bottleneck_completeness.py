...
from models_completeness import LogisticRegressionWithSummariesAndBottleneck_Wrapper
...
filename = "vasopressor_bottleneck_r{}_completeness".format(FLAGS.split_random_state)
dir_path = '/n/home07/carissawu/optimal-summaries/vasopressor/models/LOS-6-600/completeness'
with open('{file_path}.csv'.format(file_path=os.path.join(dir_path, filename)), 'a+') as csvfile: 
    ...
    csvwriter.writerow([FLAGS.num_concepts, FLAGS.opt_lr, FLAGS.opt_weight_decay, FLAGS.l1_lambda,score]) 
