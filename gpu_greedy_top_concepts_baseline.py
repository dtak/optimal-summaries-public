...
filename = "./models/LOS-6-600/baseline/vasopressor_baseline_r{}_topkinds.csv".format(r)
with open(filename, 'w') as csvfile: 
    csvwriter = csv.writer(csvfile)
    csvwriter.writerow(["Best AUC", "Best AUC ind #"])
...
for i in range(40):
    ...
    with open(filename, 'a+') as csvfile: 
        ...
        csvwriter.writerow([best_auc,best_auc_ind])
